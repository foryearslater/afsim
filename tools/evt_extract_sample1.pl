...
$pgm_name = "evt_extract_sample1.pl";
...
=head1 NAME - evt_extract_sample1.pl

=head2 SYNOPSIS

evt_extract_sample1.pl - Filter and parse "SENSOR_TRACK_INITIATED"
...
enter:
 ...
 In a Windows environment:
   perldoc -F evt_extract_sample1.pl > evt_extract_sample1_doc.txt

 In a Linux environment:
   perldoc -otext -F evt_extract_sample1.pl > evt_extract_sample1_doc.txt
...
To convert POD documentation to HTML format, enter:
 ...
 pod2html --infile=evt_extract_sample1.pl --outfile=evt_extract_sample1_doc.html
