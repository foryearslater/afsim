...
The scripts in this repository provide working utilities and sample
data post-processing tools that can be used in developing additional,
more powerful analysis tools for processing and analyzing output from
AFSIM. In many cases, these sample scripts can be adapted to process
different types of data in any text data files.
...
Critical Technology, Export Controlled; (2021 Mar 04). Other requests for this
